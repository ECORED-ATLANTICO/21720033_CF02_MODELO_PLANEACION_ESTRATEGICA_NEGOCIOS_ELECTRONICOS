...
export default {
  ...
  data: () => ({
    cuestionario: {
      tema:
        'Aspectos teóricos para la Aplicación de la estrategia en negocios electrónicos',
      titulo: 'Cuestionario',
      introduccion:
      ...
      preguntas: [
...

        {
          id: 2,
          texto:
            'La misión digital solo se utiliza para campañas publicitarias y no influye en la estrategia general.',
...

        {
          id: 4,
          texto:
            'Un plan estratégico digital no requiere alineación con los objetivos organizacionales.',
...

        {
          id: 6,
          texto:
            'La planeación estratégica digital se enfoca únicamente en redes sociales.',
...

        {
          id: 8,
          texto:
            'La visión digital describe únicamente la situación actual de la empresa en internet.',
...

        {
          id: 11,
          texto:
            'Los objetivos estratégicos no necesitan un horizonte de tiempo definido.',
          imagen: require('@/assets/actividad/imagen11.png'),
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: false },
            { id: 'b', texto: 'Falso', esCorrecta: true },
...

        {
          id: 12,
          texto:
            'El plan estratégico digital sirve como guía para la toma de decisiones a corto, mediano y largo plazo.',
...

        {
          ...
          imagen: require('@/assets/actividad/imagen13.png'),
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: true },
            { id: 'b', texto: 'Falso', esCorrecta: false },
...

        {
          id: 14,
          texto:
            'La visión digital no influye en la planificación de acciones futuras.',
          imagen: require('@/assets/actividad/imagen14.png'),
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: false },
            { id: 'b', texto: 'Falso', esCorrecta: true },
...

        {
          ...
          imagen: require('@/assets/actividad/imagen15.png'),
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: true },
            { id: 'b', texto: 'Falso', esCorrecta: false },
...

        {
          id: 16,
          texto:
            'La planeación estratégica digital es independiente del análisis del entorno digital.',
          imagen: require('@/assets/actividad/imagen16.png'),
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: false },
            { id: 'b', texto: 'Falso', esCorrecta: true },
...

        {
          id: 17,
          texto:
            'Los objetivos estratégicos deben estar alineados con la misión y la visión digital.',
          imagen: require('@/assets/actividad/imagen17.png'),
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: true },
            { id: 'b', texto: 'Falso', esCorrecta: false },
...

        {
          ...
          imagen: require('@/assets/actividad/imagen18.png'),
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: false },
            { id: 'b', texto: 'Falso', esCorrecta: true },
...

        {
          id: 19,
          texto:
            'Definir claramente la misión y visión digital fortalece la identidad de la empresa en línea.',
          imagen: require('@/assets/actividad/imagen19.png'),
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: true },
            { id: 'b', texto: 'Falso', esCorrecta: false },
...

        {
          ...
          imagen: require('@/assets/actividad/imagen20.png'),
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: false },
            { id: 'b', texto: 'Falso', esCorrecta: true },
